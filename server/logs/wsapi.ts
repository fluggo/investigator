...
wsapi.on<logCommon.DocumentID>('logs/get-bunyan-entry', function(request, callback, notifyCallback) {
  bunyan.getBunyanEntry('bunyan-' + request.data.index, request.data.id, callback);
});
wsapi.on<logCommon.DocumentID>('logs/get-msvista-entry', function(request, callback, notifyCallback) {
...
wsapi.on<logCommon.SearchQuery>('logs/search-msvista', function(request, callback, notifyCallback) {
...
wsapi.on<logCommon.SearchQuery>('logs/msvista/find-admin-logins', function(request, callback, notifyCallback) {
  return msvista.findAdminLogins(request.data, callback);
});
wsapi.on<logCommon.DocumentID>('logs/get-cylance-entry', function(request, callback, notifyCallback) {
  return cylance.getCylanceLogEntry('cylancelog-' + request.data.index, request.data.id, callback);
});
wsapi.on<logCommon.SearchQuery>('logs/search-cylance', function(request, callback, notifyCallback) {
...
wsapi.on<logCommon.SearchQuery>('logs/search-sqllog', function(request, callback, notifyCallback) {
  return sql.searchSqlLogs(request.data, callback);
});
wsapi.on<logCommon.DocumentID>('logs/get-sqllog-entry', function(request, callback, notifyCallback) {
  return sql.getSqlLogEntry('sqllog-' + request.data.index, request.data.id, callback);
});

wsapi.on<logCommon.DocumentID>('logs/get-wsalog-entry', function(request, callback, notifyCallback) {
  wsa.getWsaLogEntry('wsalog-' + request.data.index, request.data.id, callback);
});
wsapi.on<logCommon.SearchQuery>('logs/search-wsalog', function(request, callback, notifyCallback) {
...
wsapi.on<logCommon.SearchQuery>('logs/search-syslog', function(request, callback, notifyCallback) {
